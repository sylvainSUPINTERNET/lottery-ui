...
goog.exportSymbol('proto.greet.GreetResponseStream', null, global);
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.greet.Empty.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
};
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.greet.Empty} The clone.
 */
proto.greet.Empty.prototype.cloneMessage = function() {
  return /** @type {!proto.greet.Empty} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @constructor
 */
proto.greet.GreetResponseStream = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.greet.GreetResponseStream, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.greet.GreetResponseStream.displayName = 'proto.greet.GreetResponseStream';
}
 ...
 * @return {!Object}
 */
proto.greet.GreetResponseStream.prototype.toObject = function(opt_includeInstance) {
  return proto.greet.GreetResponseStream.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.greet.GreetResponseStream} msg The msg instance to transform.
 * @return {!Object}
 */
proto.greet.GreetResponseStream.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.greet.GreetResponseStream}
 */
proto.greet.GreetResponseStream.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.greet.GreetResponseStream;
  return proto.greet.GreetResponseStream.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.greet.GreetResponseStream} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.greet.GreetResponseStream}
 */
proto.greet.GreetResponseStream.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.greet.GreetResponseStream} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.greet.GreetResponseStream.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.greet.GreetResponseStream.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.greet.GreetResponseStream.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getMessage();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.greet.GreetResponseStream} The clone.
 */
proto.greet.GreetResponseStream.prototype.cloneMessage = function() {
  return /** @type {!proto.greet.GreetResponseStream} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {string}
 */
proto.greet.GreetResponseStream.prototype.getMessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 1, ""));
};


/** @param {string} value  */
proto.greet.GreetResponseStream.prototype.setMessage = function(value) {
  jspb.Message.setField(this, 1, value);
};
